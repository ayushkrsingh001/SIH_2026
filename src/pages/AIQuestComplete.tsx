...
const AIQuestComplete = () => {
  ...
  return (
    <div className="max-w-lg mx-auto text-center py-8">
      ...
      >
        {level.type === 'daily_challenge' ? t('aiQuestComplete.dailyChallengeComplete') : t('aiQuestComplete.aiQuestComplete')}
      </motion.h1>
      ...
      >
        {t('aiQuestComplete.amazingWork', { title: level.levelData.title })}
      </motion.p>
      ...
      >
        {t('aiQuestComplete.generatedByAI', { type: level.type.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase()) })}
      </motion.p>
      ...
      >
        ...
        <motion.div variants={staggerItem} className="bg-surface-container-lowest rounded-[24px] p-4 shadow-card relative overflow-hidden">
          ...
          <p className="font-body text-caption text-on-surface-variant">{t('aiQuestComplete.coins')}</p>
        </motion.div>
      ...
      >
        <p className="font-body text-caption text-primary font-semibold mb-1 flex items-center gap-1">
          ...
          {t('aiQuestComplete.whatYouLearned')}
        </p>
        ...
        {level.type === 'daily_challenge' ? (
          ...
          <>
            ...
            >
              ...
              {t('aiQuestComplete.moreAIAdventures')}
            </motion.button>
